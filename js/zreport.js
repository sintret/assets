...
function changeTypes(THIS) {
    ...
    if(val == 1){
        let html = `<textarea tabindex="" class="form-control mb-3 zreport_filters_value"  placeholder="Value" style="display:none" data-name="value" data-id="zreport_filters_value" rows="4" name="zreport[filters][${increment}][value]"></textarea>`;
